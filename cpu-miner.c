...
static enum sha256_algos opt_algo = ALGO_TWE;
...
static void *miner_thread(void *userdata)
{
	...
	while (1) {
		...
		case ALGO_SHA256D:
			...
			break;
		case ALGO_TWE:
			rc = scanhash_twe(thr_id, work.data, work.target,
			                      max_nonce, &hashes_done);
			break;	
		default:
			/* should never happen */
...
int main(int argc, char *argv[])
{
	...
	printf("\xBA  TweCoin cpu-miner (v1.0a)                       \xBA\n");
	printf("\xBA  authors: ig0tik3d/dstorm                        \xBA\n");
	printf("\xBA                                                  \xBA\n");
